...
@testset "IGEO7 Hex and IGEO7 String Parsing and Conversion" begin
...
@testset "first_non_zero Function" begin
    ...
    @testset "first_non_zero with Z7IndexComp" begin
        ...
        @test IGEO7.first_non_zero(idx2) == 1

        idx3 = Z7IndexComp(z7string_to_index("1200567").raw)
        @test IGEO7.first_non_zero(idx3) == 3
    end
end
...
@testset "GBT Neighbour Addition Functions" begin
    @testset "neighbour_addition_cw" begin
        # 0 + 0 = (0, 0)
        @test IGEO7.neighbour_addition_cw(UInt8(0), UInt8(0)) == (0, 0)
        # 0 + 1 = (0, 1)
        @test IGEO7.neighbour_addition_cw(UInt8(0), UInt8(1)) == (0, 1)
        # 1 + 1 = (1, 4)
        @test IGEO7.neighbour_addition_cw(UInt8(1), UInt8(1)) == (1, 4)
        # 1 + 2 = (0, 3)
        @test IGEO7.neighbour_addition_cw(UInt8(1), UInt8(2)) == (0, 3)
    end

    @testset "neighbour_addition_ccw" begin
        # 0 + 0 = (0, 0)
        @test IGEO7.neighbour_addition_ccw(UInt8(0), UInt8(0)) == (0, 0)
        # 0 + 1 = (0, 1)
        @test IGEO7.neighbour_addition_ccw(UInt8(0), UInt8(1)) == (0, 1)
        # 1 + 1 = (1, 2)
        @test IGEO7.neighbour_addition_ccw(UInt8(1), UInt8(1)) == (1, 2)
        # 1 + 2 = (0, 3)
        @test IGEO7.neighbour_addition_ccw(UInt8(1), UInt8(2)) == (0, 3)
    end

    @testset "neighbour_addition_ccw_mod" begin
        # 0 + 0 = (0, 0)
        @test IGEO7.neighbour_addition_ccw_mod(UInt8(0), UInt8(0)) == (0, 0)
        # 1 + 1 = (1, 2)
        @test IGEO7.neighbour_addition_ccw_mod(UInt8(1), UInt8(1)) == (1, 2)
        # 6 + 1 = (0, 0)  - mod 7(6+1) = 0
        @test IGEO7.neighbour_addition_ccw_mod(UInt8(6), UInt8(1)) == (0, 0)
    end
end
